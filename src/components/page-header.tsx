...
export function PageHeader({
  ...
  return (
    <div
      className={cn(
        "mx-auto flex max-w-[1400px] flex-col gap-4 px-4 pb-1 pt-6 sm:flex-row sm:items-end sm:justify-between sm:px-6 lg:px-8",
        className,
      )}
    >
      <div>
        {eyebrow && <div className="text-xs text-muted-foreground">{eyebrow}</div>}
        <h1 className="display-num mt-1 text-[34px] font-medium">{title}</h1>
